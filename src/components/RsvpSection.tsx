  ...
  return (
    <section id="confirmar" className="px-4 pb-12 pt-10 sm:pb-16 sm:pt-14">
      <div className="page-shell">
        <div className="mx-auto max-w-[980px] rounded-[32px] border border-[rgba(232,160,180,0.42)] bg-[rgba(254,246,240,0.96)] px-5 py-6 text-center shadow-[0_18px_44px_rgba(180,126,120,0.2)] backdrop-blur-md sm:px-10 sm:py-8">
